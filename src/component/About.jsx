  ...
  return (
    <div>
      <div style={{
        ...
        <h2 style={{ textAlign: 'center', color: 'yellow', paddingTop: '10%', fontSize: '40px' }}>Welcome to Sai Shubham Tours and Travels</h2>
      ...
      <br /> <br />
      <h5 style={{ textAlign: 'center' }}>Sai Shubham Tours and Travels</h5>
      <br />
      <p style={{ textAlign: 'center' }}> <b> Sai Shubham Tours and Travels: </b>Savaari's Shirdi taxi service is your one-stop solution for all your transportation needs in Shirdi. We take pride in offering an <br />
      ...
      <div style={{ display: 'flex', justifyContent: 'space-evenly', background: 'black', color: 'White' }}>
        <div style={{ paddingTop: '40px' }}>
          <h4>Sai Shubham Tours & Travel</h4>
          <br />
          <p>SAI SHUBHAM TOURS & TRAVEL <br /> gateway to unforgettable journeys <br />
        ...
        <div style={{ paddingTop: '40px' }}>
          <h5>CONTACT</h5><br />
          <p> 📩 saishubhamtours8994@gmail.com</p>
          <p> 📲 8669881059</p>
          <p> 📝 8669881059</p>
